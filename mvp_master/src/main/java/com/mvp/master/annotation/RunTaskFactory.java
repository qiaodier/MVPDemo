 ...
 * Desc: 该工厂类是负责通过传入的type来执行不同的SwitchRunTaskManager中注解对应的方法的
 *
 * @author iqiao
 */
...
public class RunTaskFactory {
    ...
    public static void buildRunTask(int type, String content) {
        try {
            //获取到类对象
            Class<SwitchRunTaskManager> manager = (Class<SwitchRunTaskManager>) Class.forName("com.mvp.master.annotation.SwitchRunTaskManager");
            //获取该类下的所有方法
